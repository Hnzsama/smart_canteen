...
export default function TenantMenusCreate({ categories = [] }: Props) {
    const [name, setName] = useState('');
    const [categoryId, setCategoryId] = useState<string>('none');
    const [globalCategory, setGlobalCategory] = useState<string>('makanan');
    ...
    const selectedCategoryName =
        categories.find((c) => String(c.id) === categoryId)?.name ?? 'Tanpa Kategori';
    ...
    return (
        <>
            <Head title="Tambah Menu Baru Stand - Smart Canteen FEB" />
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-8 w-full">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-border/60 pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5">
                                Daftarkan makanan atau minuman baru lengkap dengan foto, diskon, dan opsi add-on varian.
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2.5">
                        ...
                        <Button
                            ...
                            className="h-9 gap-1.5 text-xs font-bold bg-amber-500 hover:bg-amber-600 text-white"
                        >
                            {isSubmitting ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                    ...
                    <div className="lg:col-span-8 space-y-6">
                        <form id="create-menu-form" onSubmit={handleSubmit} className="space-y-6">
                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <span className="text-xs font-semibold text-foreground">
                                                                    {imageFile?.name ?? 'File foto terpilih'}
                                                                </span>
                                                                <p className="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">
                                                                    Siap diunggah ke server
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <Button
                            ...
                            <div className="rounded-xl border border-border/70 bg-card p-6 shadow-xs space-y-4">
                                <div className="flex items-center justify-between border-b border-border/50 pb-3">
                                    ...
                                    <Button
                                        ...
                                        className="h-9 text-xs gap-1.5 border-amber-500/40 text-amber-600 dark:text-amber-400 hover:bg-amber-500/10"
                                    >
                                            ...
                                            <div key={groupIdx} className="p-4 border border-border/80 rounded-xl bg-muted/20 space-y-3">
                                                ...
                                                <div className="space-y-2 pt-2 border-t border-border/40">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="h-8 text-xs text-amber-600 dark:text-amber-400 hover:bg-amber-500/10 gap-1 mt-1"
                                                    >
