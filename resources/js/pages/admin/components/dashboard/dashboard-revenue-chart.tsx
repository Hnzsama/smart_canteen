...
export function DashboardRevenueChart({ revenueTrend }: Props) {
        ...
        <Card className="col-span-1 lg:col-span-2 shadow-xs border-border/70 bg-card">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
                <div>
                    <CardTitle className="text-base sm:text-lg font-bold tracking-tight">
                        Tren Omset Harian (7 Hari Terakhir)
                    </CardTitle>
                    <CardDescription className="text-xs sm:text-sm">
                        Fluktuasi pendapatan harian lunas berdasarkan metode pembayaran Cashless & Tunai.
                    </CardDescription>
                </div>
                <div className="hidden sm:flex flex-col items-end">
                    <span className="text-xs text-muted-foreground">Akumulasi 7 Hari:</span>
            ...
            <CardContent className="pt-4">
                <ChartContainer config={chartConfig} className="aspect-auto h-[280px] w-full">
                    ...
                    >
                        <defs>
                            <linearGradient id="fillCashless" x1="0" y1="0" x2="0" y2="1">
            ...
            <CardFooter className="flex items-center justify-between border-t border-border/50 pt-3 text-xs text-muted-foreground">
                <div className="flex items-center gap-1.5 font-medium">
                    ...
                    <span>Total {totalWeeklyOrders} transaksi berhasil diproses minggu ini</span>
                </div>
                <div className="font-mono text-[11px]">Update otomatis waktu nyata</div>
            </CardFooter>
        </Card>
    );
}
